...
from .views import CommentReplyView, PostListView, PostDetailView,PostEditView, PostDeleteView,CommentDeleteView, UserProfileView, ProfileEditView, AddFollower, RemoveFollower, AddLike, AddDislike, UserSearch, ListFollowers, AddCommentLike, AddCommentDislike, PostNotification, FollowNotification, SharedView, ExploreView
...
urlpatterns = [
    ...
    path('post/<int:pk>/share', SharedView.as_view(), name='share-post'),
